...
const Experience = () => {
    return (
        <motion.div
            className='flex items-center flex-col justify-center text-gray-600 p-4 gap-5'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 border gap-4  w-full place-items-center '>
                ...
                <motion.div initial={{ opacity: 0, translateY: 50 }}
                    ...
                    viewport={{ once: false }}
                    transition={{ duration: 1 }} className='flex flex-col gap-10 border border-gray-300 p-10 h-80 rounded-xl '>
                ...
                <motion.div initial={{ opacity: 0, translateY: 50 }}
                    whileInView={{ opacity: 1, translateY: 0 }}
                    viewport={{ once: false }}
                    transition={{ delay: 0.1, duration: 1 }} className='flex flex-col gap-10 border border-gray-300 p-10  h-80  rounded-xl'>
                    <div className='flex items-center gap-5   '>
                        <div className='bg-white p-3 rounded-xl'>
                            <LuBookMinus size={40} />
                        </div>
